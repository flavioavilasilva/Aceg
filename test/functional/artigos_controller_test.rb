...
class ArtigosControllerTest < ActionController::TestCase
  ...
  test "should create artigo" do
    assert_difference('Artigo.count') do
      post :create, artigo: { artigo: @artigo.artigo, autor: @artigo.autor, data_publicacao: @artigo.data_publicacao, fonte: @artigo.fonte, status: @artigo.status, titulo: @artigo.titulo }
    end
  ...
  test "should update artigo" do
    put :update, id: @artigo, artigo: { artigo: @artigo.artigo, autor: @artigo.autor, data_publicacao: @artigo.data_publicacao, fonte: @artigo.fonte, status: @artigo.status, titulo: @artigo.titulo }
    assert_redirected_to artigo_path(assigns(:artigo))
  end
