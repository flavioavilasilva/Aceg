...
class StatusAnimaisControllerTest < ActionController::TestCase
  setup do
    @status_animal = status_animais(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:status_animais)
  end
  ...
  test "should destroy status_animal" do
    ...
    assert_redirected_to status_animais_path
  end
end
