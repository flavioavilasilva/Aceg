...
class StatusConfirmacaoDoadoresControllerTest < ActionController::TestCase
  setup do
    @status_confirmacao_doador = status_confirmacao_doadores(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:status_confirmacao_doadores)
  end
  ...
  test "should destroy status_confirmacao_doador" do
    ...
    assert_redirected_to status_confirmacao_doadores_path
  end
end
