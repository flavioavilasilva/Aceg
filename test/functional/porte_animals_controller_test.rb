...
class PorteAnimalsControllerTest < ActionController::TestCase
  setup do
    @porte_animal = porte_animals(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:porte_animals)
  end
  ...
  test "should destroy porte_animal" do
    ...
    assert_redirected_to porte_animals_path
  end
end
