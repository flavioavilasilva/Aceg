...
class PerfisControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { cpf: @perfil.cpf, data_nascimento: @perfil.data_nascimento, descricao: @perfil.descricao, endereco_perfil_id: @perfil.endereco_perfil_id }
    end
  ...
  test "should update perfil" do
    put :update, id: @perfil, perfil: { cpf: @perfil.cpf, data_nascimento: @perfil.data_nascimento, descricao: @perfil.descricao, endereco_perfil_id: @perfil.endereco_perfil_id }
    assert_redirected_to perfil_path(assigns(:perfil))
  end
